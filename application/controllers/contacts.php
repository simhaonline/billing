...
//            $ui->assign('ac',$ac);
            ...
            $ui->assign('xheader', Asset::css(array('modal','redactor/redactor','s2/css/select2.min','imgcrop/assets/css/croppic')).'
     ...
     margin-bottom: 0;
            ...
            $ui->assign('xfooter', Asset::js(array('modal','redactor/redactor.min','s2/js/select2.min','s2/js/i18n/'.lan(),'imgcrop/croppic','numeric','profile'),$file_build));
