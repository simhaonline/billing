...
// Documents table
$d = ORM::for_table('crm_accounts')->raw_query("SHOW TABLES LIKE 'sys_documents'")->find_one();
...
// Build 4597
$d = ORM::for_table('crm_accounts')->raw_query("SHOW TABLES LIKE 'sys_orders'")->find_one();
...
$d = ORM::for_table('sys_items')->raw_query("SHOW COLUMNS FROM sys_items LIKE 'payterm'")->find_one();
