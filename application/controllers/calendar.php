...
ib_date_format_moment = \''.ib_js_date_format($config['df']).'\';
 ');
        ...
        $ui->assign('xfooter',Asset::js(array('spectrum/spectrum','spectrum/i18n/'.$config['language'],'ibilling/picker/picker','ibilling/picker/date','ibilling/picker/time','validator/parsley','validator/i18n/'.Ib_I18n::get_code($config['language']),'ibilling/clockpicker/clockpicker','modal','fc/fc','fc/lang/'.$lang_code,'ibilling/calendar')));
