...
_L[\'are_you_sure\'] = \''.$_L['are_you_sure'].'\';
 ...
 ';
    ...
    case 'add':
        ...
        $mode_js = Asset::js(array('s2/js/select2.min','s2/js/i18n/'.lan(),'dp/dist/datepicker.min','dp/i18n/'.$config['language'],'numeric','modal','orders/add'));
 ...
 ');
    ...
    case 'post':
        ...
        if($generate_invoice == 'Yes'){
            ...
            $iid = Invoice::forSingleItem($cid,$p->name,$amount);
