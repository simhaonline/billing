<?php
/* Smarty version 3.1.30, created on 2018-07-19 07:45:05
  from "/var/www/html/tudlobilling_abdel/ui/theme/ibilling/localisation.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b5079c17203e0_39774969',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd5efae7813dfa63a54f6b9bed4eea224fdac73bf' => 
    array (
      0 => '/var/www/html/tudlobilling_abdel/ui/theme/ibilling/localisation.tpl',
      1 => 1510950271,
      2 => 'file',
    ),
  ),
...
function content_5b5079c17203e0_39774969 (Smarty_Internal_Template $_smarty_tpl) {
...
" <?php if ($_smarty_tpl->tpl_vars['_c']->value['language'] == $_smarty_tpl->tpl_vars['language']->value['iso_code']) {?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['language']->value['name'];?>
</option>
                            <?php
}
}
...
" <?php if (($_smarty_tpl->tpl_vars['_c']->value['home_currency'] == $_smarty_tpl->tpl_vars['currency']->value['code'])) {?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['currency']->value['symbol'];?>
...
">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="currency_symbol_position" id="currency_symbol_position">
                            ...
                            <option value="p" <?php if (($_smarty_tpl->tpl_vars['_c']->value['currency_symbol_position'] == 'p')) {?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Left'];?>
</option>
                            <option value="s" <?php if (($_smarty_tpl->tpl_vars['_c']->value['currency_symbol_position'] == 's')) {?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Right'];?>
</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="currency_decimal_digits" id="currency_decimal_digits">
                            ...
                            <option value="false" <?php if (($_smarty_tpl->tpl_vars['_c']->value['currency_decimal_digits'] == 'false')) {?> selected="selected" <?php }?>>0 (e.g. 100)</option>
                            <option value="true" <?php if (($_smarty_tpl->tpl_vars['_c']->value['currency_decimal_digits'] == 'true')) {?> selected="selected" <?php }?>>2 (e.g. 100.00)</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="thousand_separator_placement" id="thousand_separator_placement">
                            ...
                            <option value="2" <?php if (($_smarty_tpl->tpl_vars['_c']->value['thousand_separator_placement'] == '2')) {?> selected="selected" <?php }?>>2 (e.g. - 22,22,22,333)</option>
                            <option value="3" <?php if (($_smarty_tpl->tpl_vars['_c']->value['thousand_separator_placement'] == '3')) {?> selected="selected" <?php }?>>3 (e.g. - 333,333,333)</option>
                            <option value="4" <?php if (($_smarty_tpl->tpl_vars['_c']->value['thousand_separator_placement'] == '4')) {?> selected="selected" <?php }?>>4 (e.g. - 4,4444,4444)</option>
